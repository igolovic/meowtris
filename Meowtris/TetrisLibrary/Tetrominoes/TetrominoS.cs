...
{
    internal class TetrominoS : PositionedTetromino
    {
        internal override Brush TetrominoColor { get; set; } = Brushes.MediumSpringGreen;

        internal override TetrominoType Type { get; set; } = TetrominoType.S;
